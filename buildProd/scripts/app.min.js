...
/localhost/.test(hostname)
    ...
    angular.module("rest-client").controller("restController", [
        ...
        function(a, b) {
            var c = function(b) {
                (a.data = b.data), (a.headers = b.headers), (a.raw = b);
            };
            a.sendRequst = function() {
                b({
                    method: a.config.method || "GET",
                    url: a.config.url || "localhost:80",
                    data: a.config.data || null
                })
                    .then(c)
                    .catch(c);
            };
